...
# [turbo-offloader] disabled for turboCLI: comfy.model_base is referenced by model_lora_keys_unet()
...
# zoo. Kept commented so re-vendoring stays a one-line reconcile.
